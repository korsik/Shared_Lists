...
//
//                            Log.i("HELLOYOYO", "REGISTERED SUCCESSFULLY")
//                            responseMessage = "OK"
//                        } else {
//                            Log.i(
//                                "HELLOYOYO",
//                                "REGISTERED FAILEEEEEEEED     " + task.exception?.localizedMessage
//                            )
//                            responseMessage = task.exception?.localizedMessage!!
//                        }
//                    }
//                )
...
//                        val firebaseUser: FirebaseUser = task.result!!.user!!
//
////                        Log.i("HELLOYOYO", "LOGGED IN SUCCESSFULLY  " + firebaseUser.uid)
//                        responseMessage = "OK"
//                    } else {
//                        Log.i(
//                            "HELLOYOYO",
//                            "LOGGED IN FAILEEEEEEEED     " + task.exception?.localizedMessage
//                        )
//                        responseMessage = task.exception?.localizedMessage!!
//                    }
//                }.await()
//            Log.i("RESPONSE MESSAGE OK", "GET THE MESSAGE BEFORE RETURN  $responseMessage")
//            return responseMessage
//        }